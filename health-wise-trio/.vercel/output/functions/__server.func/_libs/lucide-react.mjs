...
const Infinity = createLucideIcon("infinity", __iconNode$p);
const __iconNode$o = [
  [
    "path",
    {
...
const Leaf = createLucideIcon("leaf", __iconNode$l);
const __iconNode$k = [
...
const Notebook = createLucideIcon("notebook", __iconNode$g);
const __iconNode$f = [
  [
    "path",
    {
...
const Pill = createLucideIcon("pill", __iconNode$e);
const __iconNode$d = [
  ["path", { d: "M5 12h14", key: "1ays0h" }],
