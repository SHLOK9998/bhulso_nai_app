...
import { t as invariant, u as isDangerousProtocol, k as exactPathTest, F as removeTrailingSlash, s as hasKeys, g as deepEqual, m as functionalUpdate, B as BaseRootRoute, a as BaseRoute, w as isModuleNotFoundError, x as isNotFound, q as getScrollRestorationScriptForRouter, H as rootRouteId, A as isServer, y as isRedirect, d as createNonReactiveReadonlyStore, c as createNonReactiveMutableStore, R as RouterCore, I as setupScrollRestoration, j as escapeHtml, v as isInlinableStylesheet, n as getAssetCrossOrigin, G as resolveManifestAssetLink, K as transformReadableStreamWithRouter, J as transformPipeableStreamWithRouter } from "./tanstack__router-core.mjs";
...
function MatchView({ router, matchId, resetKey, matchState }) {
  ...
  }), matchState.parentRouteId === rootRouteId ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [/* @__PURE__ */ jsxRuntimeExports.jsx(OnRendered, { resetKey }), router.options.scrollRestoration && isServer ? /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollRestoration$1, {}) : null] }) : null] });
}
...
function useScrollRestoration() {
  setupScrollRestoration(useRouter());
}
