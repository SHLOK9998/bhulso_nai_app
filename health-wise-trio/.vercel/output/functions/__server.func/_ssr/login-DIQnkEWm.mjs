...
function Login() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-md py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "rounded-2xl p-8 shadow-[var(--shadow-soft)]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold", children: t("auth.loginTitle") }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: t("auth.loginSub") }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 mt-4 justify-start", children: [{
      ...
      code: "gu",
      label: "ગુજરાતી"
    }].map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", variant: i18n.language === l.code ? "default" : "outline", onClick: () => handleLangChange(l.code), className: "h-8 rounded-full text-xs font-semibold px-3", children: l.label }, l.code)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: submit, className: "mt-6 space-y-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(PasswordInput, { id: "pw", required: true, value: password, onChange: (e) => setPassword(e.target.value), className: "mt-1.5 h-12 rounded-xl" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "submit", disabled: busy, className: "h-12 w-full rounded-xl bg-[image:var(--gradient-primary)] text-base font-semibold", children: busy ? "..." : t("auth.submitLogin") })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-center text-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/forgot-password", className: "text-muted-foreground hover:text-primary", children: t("auth.forgotLink") }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-2 text-center text-sm text-muted-foreground", children: [
      t("auth.noAccount"),
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/signup", className: "font-semibold text-primary", children: t("nav.signup") })
    ] })
  ] }) }) });
}
export {
